...
class BelongsToAssociationTest extends ActiveRecordDatabaseTestCase {
	...
	public function testRetreiveReferenced() {
		...
		$this->assertType('Supervisor', $ref);
