...
class ActiveMapperTest extends ActiveRecordDatabaseTestCase {
	...
	public function testInsert() {
		...
		$this->assertEquals("INSERT INTO [Offices] ([officeCode], [city], [phone], [addressLine1], [country], [state], [postalCode], [territory], [position]) VALUES ('9', 'Ostrava', '+420 595 846 854', 'Ostravska 69', 'NA', 'Czech Republic', '708 00', 'NA', 0)", strip(dibi::$sql));
